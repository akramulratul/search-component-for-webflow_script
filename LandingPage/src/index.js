...
function App() {
  ...
  const handleSearch = () => {
    ...
    if (selectedCity && selectedCity.searchable_type === "City") {
      ...
      baseUrl = `https://theguestbook.com/destinations/guestbook?page=1&query%5Blocation%5D%5Bbbox%5D%5B0%5D=76.16051035392279&query%5Blocation%5D%5Bbbox%5D%5B1%5D=180&query%5Blocation%5D%5Bbbox%5D%5B2%5D=-62.20793691690639&query%5Blocation%5D%5Bbbox%5D%5B3%5D=-180&stayDates%5BcheckinDate%5D=${format(
        inDate,
        "yyyy-MM-dd"
      )}&stayDates%5BcheckoutDate%5D=${format(outDate, "yyyy-MM-dd")}`;
    }
